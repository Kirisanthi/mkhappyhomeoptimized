...
<head>
    ...
    <meta name="description" content="View and manage read contact details at MK Happy Home.">
    <meta name="keywords" content="MK Happy Home, Read Contacts, Admin, Management">
    ...
    <div class="container-scroller">
        ...
        <nav aria-label="breadcrumb" class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0">
                        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-center">
                            <h4 style="color:#FFFFFF">Read Contact Details</h4>
                        </div>
        </nav>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <h4 class="card-title px-3 pt-3">Read Contact Details</h4>
                                        ...
                                        <table class="table table-striped project-orders-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Contact Details Date</th>
