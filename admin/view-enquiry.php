...
<head>
  ...
  <title>MK Happy Home|| View Contact Details</title>
  <!-- base:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">View Contact Details</h4>
          </li>
          <li class="nav-item">
            <div class="d-flex align-items-baseline">
              <p class="mb-0">Home</p>
              <i class="typcn typcn-chevron-right"></i>
              <p class="mb-0">View Contact Details</p>
            </div>
          </li>
        </ul>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">View Contact Details</h4>
                  <p class="card-description" style="padding-left: 20px;"> 
                    Contact Details has been read!!!
                  </p>
...
<table class="table table-bordered mg-b-0" style="font-size: 20px;">
                                   ...
                                   <tr style="color: blue;font-size: 20px;text-align: center;"><td colspan="6">View Contact Details</td></tr>
