...
$pagedes=$_POST['pagedes'];
     $query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='rules'");
    if ($query) {
 
    echo '<script>alert("Rules has been updated.")</script>';
  }
  else
    {
...
<head>
  ...
  <title>MK Happy Home|| Rules Page</title>
  <!-- base:css -->
